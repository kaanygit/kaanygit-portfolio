...
const Directory=()=>{
    return(
        <section className='home justify-center items-center p-10 h-full border-box h-screen mx-auto'>
            <div className='flex home-page grid grid-cols-1 h-full md:grid-cols-2 justify-center items-center'>
                <div className='w-full h-full justify-center items-center'>
                    <div>
                        <h3 className='hello font-medium text-text-color-3 text-xl tracking-wider'>Hello 👋</h3>
                    </div>
                    <div className='text-5xl tracking-widest mt-3'>
                        <h1 className='im text-black'>I'm <span className="nameSurname text-text-color-1">Yasin Kaan Yiğit</span></h1>
                    </div> 
                    <div className='mt-5'>
