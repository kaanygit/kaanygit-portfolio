    ...
    return(
        ...
        <Transition show={showPageTransition} enter='transition-opacity duration-1000' enterFrom='opacity-0' enterTo='opacity-100'>
            <section className="mx-auto flex min-h-full w-full flex-col items-center justify-center p-24 transform duration-300 ease-in-out">
                <div className="flex grid 2xl:grid-cols-4 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8 w-full">
                    {projectData.map((project:any,index:number)=>(
                        <Card className="w-full max-w-[16rem] shadow-lg" key={index}>
                            ...
                            <CardFooter className="text-xl pt-3 flex flex-row justify-evenly items-center text-center">
                                <Link href={project.githubLink} className="text-black">
                                <FiGithub/>
                                </Link>
                                <Link href={project.website} className="text-blue-500">
                                <SiWebtrees/>
                                </Link>
                            </CardFooter>
                        </Card>
